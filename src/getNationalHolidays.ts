...
export function getNationalHolidays(year: number) {
    ...
    return [
        ...
        },
        {
            ...
            description:
                "O Dia Nacional de Zumbi e da Consciência Negra é celebrado, no Brasil, em 20 de novembro. Concebido em 1971, foi formalizado nacionalmente em 2003, como uma efeméride no calendário escolar, até ser instituído como data comemorativa em 2011. Foi oficializado feriado nacional em 21 de dezembro de 2023.",
        },
    ]
}

export function isNationalHoliday(givenDate: Moment) {
...
function calculateCorpusChristi(easterDate: Moment) {
    return easterDate.clone().add(60, "d")
}

function calculateCarnival(easterDate: Moment) {
    return easterDate.clone().add(-47, "d")
}

function calculateGodsFriday(easterDate: Moment) {
