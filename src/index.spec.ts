...
describe("É dia útil? (Não considerando o estado)", () => {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                moment(item.givenDate).format("YYYY-MM-DD") +
                " (que é " +
                item.description +
                "), o resultado esperado é " +
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate)).toEqual(item.expectedResult)
            },
        )
    })
})
...
describe("É dia útil no estado do Acre?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "AC")).toEqual(item.expectedResult)
            },
        )
    })
})
...
describe("É dia útil no estado de Santa Catarina?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "SC")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de São Paulo?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "SP")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Sergipe?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "SE")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Tocantins?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "TO")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Roraima?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "RR")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Rondônia?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "RO")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Rio Grande do Sul?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "RS")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Rio Grande do Norte?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "RN")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Piauí?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "PI")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Pernambuco?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "PE")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Paraná?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "PR")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Paraíba?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "PB")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Pará?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "PA")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Minas Gerais?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "MG")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Mato Grosso do Sul?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "MS")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Mato Grosso?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "MT")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Maranhão?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "MA")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado de Espírito Santo?", () => {
    test("Espírito Santo não tem feriado estadual <3", () => {})
})

describe("É dia útil no estado de Alagoas?", () => {
    var tests = [
        {
            givenDate: "2019-06-24",
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "AL")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado do Distrito Federal?", () => {
    var tests = [
        {
            givenDate: "2019-04-21",
            description:
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "DF")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado do Ceará?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "CE")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado da Bahia?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "BA")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado do Amazonas?", () => {
    var tests = [
        {
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "AM")).toEqual(item.expectedResult)
            },
        )
    })
})

describe("É dia útil no estado do Amapá?", () => {
    var tests = [
        {
            givenDate: "2019-03-19",
            description:
    ...
    tests.forEach((item) => {
        test(
            "Dado dia " +
                ...
                item.expectedResult,
            () => {
                expect(ehDiaUtil(item.givenDate, "AP")).toEqual(item.expectedResult)
            },
        )
    })
})
