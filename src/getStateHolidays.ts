...
export function getStateHolidays(year: number, uf?: string) {
    const holidaysByStateCode = [
        {
            state: "SP",
            date: moment(`${String(year)}-07-09`),
            description:
        ...
        {
            state: "AL",
            date: moment(`${String(year)}-06-29`),
            description: "São Pedro - Lei estadual nº 5.509/1993",
        },
        {
            state: "AL",
            date: moment(`${String(year)}-09-16`),
        ...
        {
            state: "DF",
            date: moment(`${String(year)}-11-30`),
            description: "Dia do evangélico - Lei distrital nº 963/1995",
        },
        {
            state: "AM",
            date: moment(`${String(year)}-09-05`),
            description:
